...
const HeroSection = () => {
  return (
    <section className="min-h-[100dvh] w-full flex flex-col justify-center relative z-10 px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-32 max-w-7xl mx-auto">
